...
def complete(id):
    def _complete():
        ...
        conn.commit()
    return _complete # devolvemos una función, es como encapsularlo en un lambda pero devolviendo 
                     # la función con el parámetro iterado en vez de coger el último (técnica llamada currying)
...
e.focus() #pone el focus en este elemento 
